...
let s:p.insert.left     = [ [ 'NONE', 'NONE', 0, 2, 'bold' ], s:p.normal.left[1] ]
let s:p.visual.left     = [ [ 'NONE', 'NONE', 0, 3, 'bold' ], s:p.normal.left[1] ]
let s:p.replace.left    = [ [ 'NONE', 'NONE', 0, 1, 'bold' ], s:p.normal.left[1] ]
let s:p.inactive.left   = [ [ 'NONE', 'NONE', 8, 0, 'bold' ], [ 'NONE', 'NONE', 7, 0 ] ]
